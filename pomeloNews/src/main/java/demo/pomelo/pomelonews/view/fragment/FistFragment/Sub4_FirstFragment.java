...
public class Sub4_FirstFragment extends BaseSubFragment {
    private static Sub4_FirstFragment sub4_firstFragment;
    ...
    public static Sub4_FirstFragment newInstance() {
        if (sub4_firstFragment == null) {
            sub4_firstFragment = new Sub4_FirstFragment();
        }
        return sub4_firstFragment;
    }
