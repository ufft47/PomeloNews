...
public class Sub6_FirstFragment extends BaseSubFragment{

    private static Sub6_FirstFragment sub6_firstFragment;
    ...
    public  Items items = null;  //相当于List<Object>
    public List<News_Toutiao.ResultBean.DataBean> listBean = new ArrayList<>();
    public  MultiTypeAdapter mAdapter = null;


    public  static Sub6_FirstFragment newInstance(){
       if(sub6_firstFragment==null){
           sub6_firstFragment = new Sub6_FirstFragment();
       }
        return sub6_firstFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView  recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recyclerview_fragment_first_sub_1);
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(viewGroup.getContext());
        ...
        DataBeanViewProvider mProvider = new DataBeanViewProvider(items);
        //注册类型和View的对应关系
