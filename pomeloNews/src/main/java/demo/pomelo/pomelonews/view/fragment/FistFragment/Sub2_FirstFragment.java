...
public class Sub2_FirstFragment extends BaseSubFragment {
    private static Sub2_FirstFragment sub2_firstFragment;
    ...
    public DataBeanViewProvider mProvider = null;


    //创建一个类的实例对象
    public static Sub2_FirstFragment newInstance() {
        if (sub2_firstFragment == null) {
            sub2_firstFragment = new Sub2_FirstFragment();
        }
        return sub2_firstFragment;
    }
