...
public class Sub3_FirstFragment extends BaseSubFragment {
    private static Sub3_FirstFragment sub3_firstFragment;
    ...
    public static Sub3_FirstFragment newInstance() {
        if(sub3_firstFragment==null){
            sub3_firstFragment = new Sub3_FirstFragment();
        }
        return sub3_firstFragment;
    }
