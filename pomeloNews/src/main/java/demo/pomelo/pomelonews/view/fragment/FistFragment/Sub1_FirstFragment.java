...
public class Sub1_FirstFragment extends BaseSubFragment {
    private static Sub1_FirstFragment sub1_firstFragment;
    ...
    private  Items items;  //相当于List<Object>
    ...
    //创建一个类的实例对象
    public static Sub1_FirstFragment newInstance() {
        if(sub1_firstFragment == null){
            sub1_firstFragment = new Sub1_FirstFragment();
        }
        return sub1_firstFragment;
    }
